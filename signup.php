...
<div id="container">
    ...
    <h1 class="heading" style="color:beige">SIGN UP</h1>
    <div class="txt">
...
// Check if password and confirm password match
 if ($password != $confirm_password) 
  { 
    echo "<div class='error' style='color:red'>Both password not matched please enter again</div>";
  }else {
   ...
   {
   echo "<div class='error' style='color:red'>Username or Email already exists.</div>";
  } else {
